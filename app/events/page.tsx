          ...
          <div className="max-w-2xl mx-auto text-center">
            <div className="bg-white rounded-lg shadow-lg p-8 border border-gray-200">
              <p className="text-gray-700 text-lg mb-4">
                We are currently planning our next events. Stay tuned for announcements about upcoming camps and workshops!
              </p>
              <Link href="/contact">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden border border-gray-200">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-700 mb-6">
                  Successfully completed a virtual STEM camp for students across Africa, featuring hands-on experiments and
                  coding activities in partnership with Africa ICT Rights.
                </p>
